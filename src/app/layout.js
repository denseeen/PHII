        ...
        <footer className="bg-white shadow-sm w-full dark:bg-gray-800 mt-10">
          <div className="w-full mx-auto max-w-screen-xl px-6 py-8 flex flex-col md:flex-row md:justify-between md:items-center">
            ...
            <div className="text-lg font-semibold text-gray-800 dark:text-white mb-6 md:mb-0">
              <h2>CONTACTS</h2>
              <h2 className="text-4xl font-bold font-serif">PHII</h2>
              <br></br>
              <ul className="space-y-2 text-sm text-gray-500 dark:text-gray-400">
                <li><strong>Website:</strong> <a className="hover:text-blue-500">www.thebusinessmanual-onemega.com</a></li>
                <li><strong>Email:</strong> <a className="hover:text-blue-500">info@thebusinessmanual-onemega.com</a></li>
              </ul>
            </div>
          </div>
